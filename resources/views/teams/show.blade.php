    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex flex-col items-center justify-center">
        <div class="mx-auto max-w-3xl w-full md:min-w-2xl">
                ...
                <div class="grid grid-cols-1 rounded-[2rem] p-2 shadow-md shadow-black/5">
                    <div class="rounded-3xl bg-white dark:bg-secondary-900 shadow-2xl ring-1 ring-black/5 dark:ring-white/5">
                        <flux:navbar class="border-b dark:border-secondary-700 px-6 pt-3">
                            ...
                            <flux:navbar.item href="{{ route('app.teams.show-members', $currentTeam) }}"
                                              :current="request()->routeIs('app.teams.show-members')"
                                              icon="users">
                                {{ __('Members') }}
                            </flux:navbar.item>

                            <flux:navbar.item href="{{ route('app.teams.show-billing', $currentTeam) }}"
                                              :current="request()->routeIs('app.teams.show-billing')"
                                              icon="banknotes">
                                {{ __('Billing') }}
                            </flux:navbar.item>
                        </flux:navbar>
                        ...
                        <div class="p-6">
                            @if (request()->routeIs('app.teams.show'))
                                <livewire:teams.edit :team="$currentTeam" />
            ...
            <div class="mt-6 flex justify-center">
                <flux:button href="{{ route('app.dashboard') }}"
                             variant="ghost"
                             icon="arrow-left">
                    {{ __('Back to the panel') }}
                </flux:button>
            </div>
        </div>
    </div>
